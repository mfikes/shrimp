...
*Note: As a cool aside, this uses the ClojureScript [Quick Start](https://github.com/clojure/clojurescript/wiki/Quick-Start) `cljs.jar` along with a small bit of `mvn` to manage deps. No `lein cljsbuild`!*
...
1. Run `rlwrap mvn compile -Prepl` in the `ClojureScript` directory
